...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            ...
            <a href="javascript:if(confirm('您真的要退出吗？')){location.href='${pageContext.request.contextPath}/login.jsp'}">退出</a>
        </div>
    </header>
<!--时间-->
     ...
     <div class="left">
         ...
         <nav>
             <ul class="list">
              ...
              <li><a href="javascript:if(confirm('您真的要退出吗？')){location.href='${pageContext.request.contextPath}/login.jsp'}">退出系统</a></li>
             </ul>
         </nav>
     </div>